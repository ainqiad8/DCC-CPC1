        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.jobs.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="title" value="{{ old('title') }}" id="title" type="text"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value="{{ old('company_name') }}" name="company_name" id="company_name"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor " name="company_details" placeholder="Company Details">{{ old('company_details') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="vacancy" value="{{ old('vacancy') }}" id="vacancy" type="number"
                        placeholder="Default input" aria-label="default input example">
                    @error('vacancy')
                        <div class=" my-2 alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    @foreach ($jobtypes as $jobtype)
                        <div class="form-check">
                            <input class="form-check-input" name="jobtypes[]" type="checkbox" value="{{ $jobtype->id }}"
                                id="{{ 'jobtype_' . $jobtype->id }}" {{ in_array($jobtype->id, old('jobtypes',[])) ? 'checked' : '' }}>
                    ...
                    @foreach ($experiencelevels as $experiencelevel)
                        <div class="form-check">
                            <input class="form-check-input" name="experience_level[]" type="checkbox"
                                value="{{ $experiencelevel->id }}" id="{{ 'experience_leve_' . $experiencelevel->id }}" {{ in_array($experiencelevel->id, old('experience_level',[])) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control " name="short_experience_requirements" placeholder="Short Experience requirements">{{ old('short_experience_requirements') }}</textarea>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" name="experience_requirements" placeholder="Experience requirements">{{ old('experience_requirements') }}</textarea>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" name="educational_requirements" placeholder="Educational requirements">{{ old('educational_requirements') }}</textarea>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control " name="additional_requirements" placeholder="Additional requirements">{{ old('additional_requirements') }}</textarea>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control " name="job_location" placeholder="Job Location">{{ old('job_location') }}</textarea>
                        @error('job_location')
                            <div class=" my-2 alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="salary" placeholder="Job Salary">{{ old('salary') }}</textarea>
                        @error('salary')
                            <div class=" my-2 alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" name="benefits" placeholder="Job benefits">{{ old('benefits') }}</textarea>
                        @error('benefits')
                            <div class=" my-2 alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="age" placeholder="Job Age">{{ old('age') }}</textarea>
                        @error('age')
                            <div class=" my-2 alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="gender[]" type="checkbox" value="Male" id="male"  {{ in_array('Male', old('gender',[])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="male">
                            Male
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="gender[]" type="checkbox" value="Female" id="Female" {{ in_array('Female', old('gender',[])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="Female">
                            Female
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="gender[]" type="checkbox" value="Others" id="Others" {{ in_array('Others', old('gender',[])) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" name="apply_instruction" placeholder="Apply Instruction">{{ old('apply_instruction') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor" name="apply_procedure" placeholder="Apply Procedure">{{ old('apply_procedure') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="date" name="deadline" id="deadline" name="deadline" value="{{ old('deadline') }}">
                    @error('deadline')
                        <div class=" my-2 alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check mb-3">
                        <input name="has_online_apply" value="1" type="checkbox" class="form-check-input"
                            id="has_online_apply" {{ old('has_online_apply')==null ? '':'checked' }}>
                ...
                <div class="form-check mb-3">
                    <input name="is_active" value="1" type="checkbox" class="form-check-input" id="is_active" {{ old('is_active')==1 ? 'checked':'' }}>
