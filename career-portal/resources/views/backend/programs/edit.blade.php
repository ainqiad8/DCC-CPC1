...
<div class="d-flex justify-content-end pt-3 pb-2 p-3">
  <a class="btn btn-info px-3  py-2" href="{{ route('admin.programs.index') }}">List</a>
  ...
  <div class="card-body">
      <form action="{{ route('admin.programs.update',$program->id) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <input value="{{old('title',$program->title) }}" class="form-control" name="title" id="title" type="text" placeholder="Default input"
          ...
          <div class="form-group">
              ...
              <div class="my-2">
                <img style="height:150px;" src="{{asset('storage/programs/'.$program->thumbnail) }}">
              </div>
          ...
          <div class="form-group">
              ...
              <textarea class="form-control" name="short_description" placeholder="Short Description" id="floatingTextarea">{{ old('short_description',$program->short_description) }}</textarea>
          </div>
          <div class="form-group">
              <label for="description">Description</label>
              <textarea class="form-control" name="description" placeholder="Description" id="description">{{ old('description',$program->description) }}</textarea>
          </div>

          <div class="form-group">
              <label for="program_date">Event date</label>
              <input  class="form-control" type="date" name="program_date" id="program_date" value="{{ old('program_date',$program->program_date) }}" name="birthday">
          </div>

          <div class="form-check mb-3">
              <input name="is_active" value="1"  type="checkbox" class="form-check-input" id="is_active" {{$program->is_active ? 'checked':''}} >
