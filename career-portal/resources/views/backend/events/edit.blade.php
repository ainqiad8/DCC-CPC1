  ...
  <div class="card-body">
      <form action="{{ route('admin.events.update',$event->id) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <input value="{{old('title',$event->title) }}" class="form-control" name="title" id="title" type="text" placeholder="Default input"
          ...
          <div class="form-group">
              ...
              <div class="my-2">
                <img style="height:150px;" src="{{asset('storage/events/'.$event->thumbnail) }}">
              </div>
          ...
          <div class="form-group">
              ...
              <textarea class="form-control" name="short_description" placeholder="Short Description" id="floatingTextarea">{{ old('short_description',$event->short_description) }}</textarea>
          </div>
          <div class="form-group">
              <label for="description">Description</label>
              <textarea class="form-control" name="description" placeholder="Description" id="description">{{ old('description',$event->description) }}</textarea>
          </div>

          <div class="form-group">
              <label for="event_date">Event date</label>
              <input  class="form-control" type="date" name="event_date" id="event_date" value="{{ old('event_date',$event->event_date) }}" name="birthday">
          </div>

          <div class="form-check mb-3">
              <input name="is_active" value="1"  type="checkbox" class="form-check-input" id="is_active" {{$event->is_active ? 'checked':''}} >
