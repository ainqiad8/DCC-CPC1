...
@section('content')
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-2 flex items-center ">
                <div class="col-span-2 md:col-span-1">
                    <img class="bg-cover" src="{{asset('frontend/assets/herosection/get_help.jpg')}}" alt="" srcset="">
                </div>
                <div class="col-span-2 md:col-span-1 p-4">
                    <h1 class="text-4xl font-bold text-gray-600 tracking-wide">Get Help Writing
                        Cover Let<span class="text-red-500">ter ?</span></h1>
                    <h2 class="text-sm text-gray-600 py-3 ">Get help from professional <span
                            class="text-red-500 text-xl ">?</span></h2>
                    <p class="text-gray-600 text-justify">Our Website contains thousands of Cover
                        Letter
                        examle.
    ...
    <div class="mb-6">
        <div class="container mx-auto">
            <h1 class="text-center py-3  mb-6 font-bold text-xl  ">Examples of Cover Letter </h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 md:grid-cols-3 gap-2 px-4">
                @foreach ($coverletters as $coverletter) 
                   <div
                      ...
                      <div class="p-2">
                          <a class="text-primary hover:text-secondary font-semibold capitalize " href="{{asset('storage/coverletters/'.$coverletter->file)}}" download>{{$coverletter->title}}</a>
                          <p class="text-gray-500 capitalize text-sm"> version : {{$coverletter->version}}</p>
                      </div>
                   </div>
               @endforeach
            </div>
